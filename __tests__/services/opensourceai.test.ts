...
describe('getOpenModelChatCompletion', () => {
  ...
  it('should return the correct response message on successful fetch', async () => {
    ...
    const response = await getOpenModelChatCompletion(basePrompt, chatHistory, userMessage, fetchedText, selectedModel, serverURL)
  ...
  it('should handle network errors correctly', async () => {
    ...
    await expect(getOpenModelChatCompletion(basePrompt, chatHistory, userMessage, fetchedText, selectedModel, serverURL))
